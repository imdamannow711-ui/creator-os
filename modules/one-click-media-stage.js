...
/* Legacy preview installer intentionally disabled.
   one-click-browser-executor.js is the single owner of current clip,
   preview source, duration, trim state, and Previous/Next navigation. */
function installMultiClipPreviewUI(){return {disabled:true,owner:'one-click-browser-executor.js'};}
